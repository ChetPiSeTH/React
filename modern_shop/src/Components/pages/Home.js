			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src={img1} alt="Untree.co"/></div>
							<div class="grid grid-2"><img src={img2} alt="Untree.co"/></div>
							<div class="grid grid-3"><img src={img3} alt="Untree.co"/></div>
						</div>
					</div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-4 mb-4 mb-lg-0">
						<div class="product-item-sm d-flex">
							<div class="thumbnail">
								<img src={p_3} alt="Image" class="img-fluid"/>
							</div>
							<div class="pt-3">
